...
Por otro lado, se tienen diferentes carpetas donde se han ido almacenando las pruebas y los códigos:
 - Otros códigos: post-procesado de aceleraciones o datos relacionados con la GPU (para la ejecución, cambiar la ruta de lectura de los ficheros (están en datosGPUyAceleraciones).
 ...
 - GMRES-Learning-main: código principal del artículo con modificaciones.
